...
import fr.utt.if26.loltool_frontend.dao.MatchMetaDAO;
...
@Database(entities = {User.class, Summoner.class, Follower.class, MatchMeta.class}, version = 1, exportSchema = false)
public abstract class MyDataBase extends RoomDatabase {

    public abstract UserDAO userDAO();
    public abstract SummonerDAO summonerDAO();
    public abstract FollowerDAO followerDAO();
    public abstract MatchMetaDAO matchMetaDAO();
